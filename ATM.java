...
class BankAccount {
    ...
    static void showOptions(String userName) {
...
class Transactions {
    static void withdrawCash() {
        ...
        if (withdrawalAmount <= ATM.accountBalance) {
            ...
            ATM.transactionHistory.add("Withdraw: " + withdrawalAmount);
    ...
    static void depositCash() {
        ...
        ATM.transactionHistory.add("Deposit: " + depositAmount);
    ...
    static void transferFunds() {
        ...
        if (transferAmount <= ATM.accountBalance) {
            ...
            ATM.transactionHistory.add("Transfer: " + transferAmount + " to " + recipient);
